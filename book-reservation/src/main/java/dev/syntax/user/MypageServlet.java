...
public class MypageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int userId = util.SessionUtils.getUserId(request);
        String userName = util.SessionUtils.getUserName(request);
        String userEmail = util.SessionUtils.getUserEmail(request);
        ...
        try (
            Connection conn = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/book_reservation?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true",
                "root", "1234");

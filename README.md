...
### 2.4 “인덱스를 쓰면 되지 않나?”에 대한 답 — B-Tree 제약 (9–10p)
...
### 3.5 다양한 검색 기능 — 한국어 형태소, 자동완성, 오타 교정 (17–19p)
...
저는 “저장”과 “검색”의 관심사를 분리했습니다. 그 결과, **속도 문제**와 **검색 UX 품질**을 동시에 끌어올릴 수 있었습니다. 특히 **부분 검색/오타 허용/자동완성/연관도 정렬** 같은 요소는 사용자 경험을 완전히 다르게 만듭니다. **도서 대출 시스템**처럼 검색이 핵심인 서비스라면, ES 도입을 **첫 번째 선택지**로 충분히 고려할 만합니다.
